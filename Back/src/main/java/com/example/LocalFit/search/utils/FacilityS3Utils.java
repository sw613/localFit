...
import static com.example.LocalFit.search.utils.AwsConstants.FACILITY_FOLDER;
import static com.example.LocalFit.search.utils.AwsConstants.ORIGINAL_BUCKET_NAME;

@Slf4j
@Component
@RequiredArgsConstructor
public class FacilityS3Utils {
    ...
    public String downloadFile(String s3Url) {
        ...
        try (S3Object s3Object = amazonS3.getObject(ORIGINAL_BUCKET_NAME, FACILITY_FOLDER + "/" + FileUtils.extractFileName(s3Url));
